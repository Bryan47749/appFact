...
export class NewSaleComponent implements OnInit {
  ...
  public clientForm = this.formBuilder.group({
    'ClientID': [{value: 'Consumidor Final', disabled: true}, Validators.required],
    'ClientName': [{value: 'Consumidor Final', disabled: true}, Validators.required],
    'ClientCedula': [{value: 'Consumidor Final', disabled: true}, Validators.required],
    'ClientEmail': [{value: 'Consumidor Final', disabled: true}, Validators.required]
  })
  //#endregion
